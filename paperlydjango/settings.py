"""
Django settings for paperlydjango project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)#c(sey66xgdl179n62j-+tsj0%2+ino(d^rove-!m%m(&$)!e')
...
WSGI_APPLICATION = 'paperlydjango.wsgi.application'
